...
//			Page<NewsDTO> result;
//
//			if (keyword != null && !keyword.trim().isEmpty() && actualCategory != null
//					&& !actualCategory.trim().isEmpty()) {
//				// 키워드 + 카테고리 검색
...
//		return Arrays.asList("AI 기술", "경제 동향", "스포츠 뉴스", "정치 소식", "문화 예술", "IT 트렌드", "건강 정보", "환경 이슈");
//	}
//
//	/**
//	 * 자동완성 검색어 제안
...
//		try {
//			// 실제 크롤링된 카테고리들 조회
//			List<String> actualCategories = Arrays.asList("economy", "politics", "society", "sports", "culture",
//					"opinion", "health");
